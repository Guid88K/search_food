        ...
        <div class="content">
            <div class="my-50 text-center">
                <h2 class="font-w700 text-black mb-10">
                    <i class="fa fa-plus text-muted mr-5"></i> Редагування рецепту
                </h2>
            ...
            <div class="block block-rounded block-fx-shadow">
                <div class="block-content">
                            ...
                            <div class="col-lg-7 offset-lg-1">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-lg" id="re-listing-name"
                                           value="{{$recipe->recipe_name}}" name="name">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-lg-7 offset-lg-1">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="kind_of_recipe" name="kind_of_recipe">
                                        @if($recipe->kind_of_recipe == 'first_dish')
                                            <option value="first_dish" selected>Перші страви</option>
                                        ...
                                        @endif  @if($recipe->kind_of_recipe == 'second_dish')
                                            <option value="first_dish">Перші страви</option>
                                            <option value="second_dish" selected>Другі страви</option>
                                            <option value="salad" selected>Салати</option>
                                            <option value="snack">Закуска</option>
                                            <option value="baking">Випічка</option>
                                            <option value="dessert">Десерти</option>
                                            <option value="drinks">Напої</option>
                                        @endif  @if($recipe->kind_of_recipe == 'salad')
                                            <option value="first_dish">Перші страви</option>
                                            <option value="second_dish">Другі страви</option>
                                            <option value="salad" selected>Салати</option>
                                            <option value="snack">Закуска</option>
                                            ...
                                            <option value="dessert">Десерти</option>
                                            <option value="drinks">Напої</option>
                                        @endif  @if($recipe->kind_of_recipe == 'snack')
                                            <option value="first_dish">Перші страви</option>
                                            <option value="second_dish">Другі страви</option>
                                            <option value="salad" selected>Салати</option>
                                            <option value="snack" selected>Закуска</option>
                                            <option value="baking">Випічка</option>
                                            <option value="dessert">Десерти</option>
                                            <option value="drinks">Напої</option>
                                        @endif  @if($recipe->kind_of_recipe == 'baking')
                                            <option value="first_dish">Перші страви</option>
                                            <option value="second_dish">Другі страви</option>
                                            <option value="salad" selected>Салати</option>
                                            <option value="snack">Закуска</option>
                                            <option value="baking" selected>Випічка</option>
                                            <option value="dessert">Десерти</option>
                                            <option value="drinks">Напої</option>
                                        @endif  @if($recipe->kind_of_recipe == 'dessert')
                                            <option value="first_dish">Перші страви</option>
                                            <option value="second_dish">Другі страви</option>
                                            <option value="salad" selected>Салати</option>
                                            <option value="snack">Закуска</option>
                                            <option value="baking">Випічка</option>
                                            <option value="dessert" selected>Десерти</option>
                                            <option value="drinks">Напої</option>
                                        @endif  @if($recipe->kind_of_recipe == 'drinks')
                                            <option value="first_dish">Перші страви</option>
                                            <option value="second_dish">Другі страви</option>
                                            <option value="salad" selected>Салати</option>
                                            <option value="snack">Закуска</option>
                            ...
                            <div class="col-lg-7 offset-lg-1">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control form-control-lg" id="re-listing-description"
                                              name="description_for_recipe"
                                              rows="8">{{$recipe->recipe_description}}</textarea>
                                </div>
                                        ...
                                        @if($loop->first)
                                            <div class="input-group mb-3">
                                                ...
                                                <input
                                                    ...
                                                    aria-label="Text input with checkbox"
                                                    value="{{$i->ingredient_count}}"
                                                    name="count[]"/>
                                                <input
                                                    type="text" class="form-control col-xs-2 ml-3 mr-3"
                                                    aria-label="Text input with checkbox"
                                                    value="{{$i->ingredient_kind}}"
                                                    name="kind[]"/>
                                        ...
                                        <div class="div">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="div">
                                                    ...
                                                    <img width="300" height="200" src="{{asset('upload/'.$fr->image)}}"
                                                         id="output"/>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-7 offset-lg-1">
                                            <div class="form-group">
                                                <div class="input-group mb-3">
                                                    <textarea class="form-control" id="re-listing-description"
                                                              name="description[]"
                                                              rows="11"> {{$fr->description}}</textarea>
                                                    <div class="input-group-prepend delete">
                                                        <div class="input-group-text  add_form_field_copy1 ">
                                                            <i class="fa fa-minus text-dark"></i>
                    ...
                    {{--                                    <input class="form-control form-control-lg" type="time" value="09:00"--}}
                    {{--                                           name="start_hour" id="start_hour">--}}
                    {{--                                </div>--}}
                    {{--                                <div class="form-group">--}}
                    {{--                                    <label for="re-listing-name">Година закриття</label>--}}
                    {{--                                    <input class="form-control form-control-lg" type="time" value="18:00"--}}
                    {{--                                           name="end_hour" id="end_hour">--}}
                    {{--                                </div>--}}
                    {{--                            </div>--}}
                    {{--                        </div>--}}
                    <!-- END Contact Info -->
