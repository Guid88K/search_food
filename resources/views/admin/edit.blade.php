                        ...
                        <div class="col-lg-7 offset-lg-1">
                            <div class="form-group">
                                ...
                                <select class="form-control" id="kind_of_recipe" name="kind_of_recipe">
                                    <option value="first_dish" @if($recipe->kind_of_recipe == 'first_dish')  selected @endif >Перші страви</option>
                                    <option value="second_dish @if($recipe->kind_of_recipe == 'second_dish')  selected @endif">Другі страви</option>
                                    <option value="salad" @if($recipe->kind_of_recipe == 'salad')  selected @endif>Салати</option>
                                    <option value="snack" @if($recipe->kind_of_recipe == 'snack')  selected @endif>Закуска</option>
                                    <option value="baking" @if($recipe->kind_of_recipe == 'baking')  selected @endif>Випічка</option>
                                    <option value="dessert" @if($recipe->kind_of_recipe == 'dessert')  selected @endif>Десерти</option>
                                    <option value="drinks" @if($recipe->kind_of_recipe == 'drinks')  selected @endif>Напої</option>
